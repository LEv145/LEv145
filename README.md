...
- Asynchronous Python and concurrent I/O
- Backend and service architecture
- APIs and third-party integrations
- Data collection and web automation
- Networking and developer tooling

**Technologies:** Python, asyncio, aiohttp, FastAPI, Django, PostgreSQL,
SQLAlchemy, Docker, Linux, Git.
